...
const endPoint = "topshiriq/superadmin_oz_sohasida_topshiriq/";
...
const APISuperadminSoxaOid = { get, getbyId, getByPage, post, patch, put, del };

export default APISuperadminSoxaOid;
