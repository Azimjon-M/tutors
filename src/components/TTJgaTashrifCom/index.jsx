...
function TTJgaTashrifCom() {
  ...
  return (
    <div className="border border-gray-400 rounded-md shadow-md shadow-gray-200 mt-5 p-3 h-1/2 overflow-y-auto">
      <div className="collapse collapse-arrow rounded-md bg-white mb-3">
        ...
        <div className="collapse-content">
          <div className="bg-slate-100 rounded-md p-3">
            <div className="flex items-center justify-between">
              <p className="text-sm md:text-base text-slate-600">22.02.2025 yil</p>
            ...
            <div className="px-5 pt-5">
              <h1 className="text-xl md:text-2xl font-semibold text-slate-600 text-center">Click to open this one and close others</h1>
            </div>
      ...
      {/* <div className="collapse collapse-arrow rounded-md bg-white">
        ...
        <div className="collapse-content">
          <div className="bg-slate-200 rounded-md p-3">
            <div className="flex items-center justify-between">
              <p className="text-sm md:text-base">22.02.2025 yil</p>
              <button className="flex items-center gap-1 px-4 py-1 rounded-md bg-green-500 text-white text-sm md:text-base font-semibold">
                Yuklash olish <MdOutlineCloudDownload className="inline text-xl md:text-2xl"/>
              </button>
            </div>
            <div className="flex items-center gap-5 mt-5 px-5">
              <div className="flex-1"><img src={rasm1} alt="university events" className="w-full max-h-72 rounded-md shadow-2xl" /></div>
              <div className="flex-1"><img src={rasm2} alt="university events" className="w-full max-h-72 rounded-md shadow-2xl"/></div>
            </div>
          </div>
        </div>
      </div> */}
