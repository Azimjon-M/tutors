        ...
        <div className="relative z-0">
            ...
            <div className="relative w-full bg-white shadow-md rounded-lg">
                <div className="overflow-y-auto max-h-[740px]">
                    {/* Thead */}
                    <div className="sticky top-0 bg-gray-100 grid grid-cols-6 text-center shadow-[0_6px_6px_-2px_rgba(0,0,0,0.1)]">
                        {[
                            "№",
                            "Isim Familya",
                            "Topshiriq/Bajargani",
                    ...
                    <div>
                        {data.map((item, index) => (
                            <div
                                key={item.id}
                                className="grid grid-cols-6 text-center hover:bg-gray-50 border-b"
                            >
