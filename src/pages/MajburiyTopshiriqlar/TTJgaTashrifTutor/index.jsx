    ...
    <div>
      <div className="max-w-7xl mx-auto px-5">
        <div className="flex justify-start bg-white rounded-md shadow-md shadow-gray-200 mt-8 p-3">
          <div
            class="flex w-2/4 h-2 bg-gray-200 rounded-full overflow-hidden dark:bg-neutral-700"
            role="progressbar"
            aria-valuenow="25"
            aria-valuemin="0"
            aria-valuemax="100"
          >
            <div
              class="flex flex-col justify-center overflow-hidden bg-blue-600 text-xs text-white text-center whitespace-nowrap transition duration-500 dark:bg-blue-500 w-2/4"
